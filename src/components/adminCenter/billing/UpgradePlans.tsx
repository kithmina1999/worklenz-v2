                ...
                <Col span={6} style={{ padding: '0 4px' }}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;<span>{t('freeText01')}</span>
                            </div>
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;<span>{t('freeText02')}</span>
                            </div>
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;<span>{t('freeText03')}</span>
                            </div>
                        </div>
                    </Card>
                </Col>
                ...
                <Col span={6} style={{ padding: '0 4px' }}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;
                                <span>{t('startupText02')}</span></div>
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;
                                <span>{t('startupText03')}</span></div>
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;
                                <span>{t('startupText04')}</span></div>
                            <div><CheckCircleFilled style={{ color: '#52c41a' }} />&nbsp;
                                <span>{t('startupText05')}</span></div>
                        </div>
                    </Card>
                </Col>
                ...
                <Col span={6} style={{ padding: '0 4px' }}>
                    <Card
                        ...
                        title={<span style={{
                            ...
                            gap: '4px',
                            justifyContent: 'center',
                        }}>{t('business')} <Tag color="volcano">{t('tag')}</Tag></span>}
