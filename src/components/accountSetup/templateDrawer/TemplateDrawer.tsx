            ...
            children: (
                <div style={{ display: 'flex', height: 'calc(100vh - 200px)' }}>
                    ...
                    <div className="temp-details" style={{ flex: 1 }}>
                        ...
                        <img src="https://worklenz.s3.amazonaws.com/project-template-gifs/bug-tracking.gif"
                             alt="preview" />
                        <div>
                            {/* Description */}
                            <div style={{ display: 'flex', marginBottom: '1rem' }}>
                                ...
                                <div>
                                    <Text>The “Bug Tracking” project template is a versatile solution meticulously
                                        designed to streamline and enhance the bug management processes of businesses
                                        across diverse industries. This template is especially valuable for
                                        organizations that rely on software development, IT services, or digital product
                                        management. It provides a structured and efficient approach to tracking,
                                        resolving, and improving software issues.</Text>
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', marginBottom: '1.5rem' }}>
                                ...
                                <div>
                                    <Tag color="#75c9c069"
                                         style={{ color: 'black', marginBottom: '8px' }}>Incoming</Tag>
                                    <Tag color="#3b7ad469" style={{ color: 'black', marginBottom: '8px' }}>Backlog</Tag>
                                    <Tag color="#7781ca69" style={{ color: 'black', marginBottom: '8px' }}>Development
                                        work</Tag>
                                    <Tag color="#bf494969"
                                         style={{ color: 'black', marginBottom: '8px' }}>Resolved</Tag>
                                    <Tag color="#ff9c3c69" style={{ color: 'black', marginBottom: '8px' }}>Testing &
                                        Review</Tag>
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', marginBottom: '1.5rem' }}>
                                ...
                                <div>
                                    <Tag color="#cbbc7869" style={{ color: 'black', marginBottom: '8px' }}>UI/UX
                                        Bug</Tag>
                                    <Tag color="#7781ca69" style={{ color: 'black', marginBottom: '8px' }}>Ready for
                                        Dev</Tag>
                                    <Tag color="#cb987869"
                                         style={{ color: 'black', marginBottom: '8px' }}>Regression</Tag>
                                    <Tag color="#154c9b69"
                                         style={{ color: 'black', marginBottom: '8px' }}>Critical</Tag>
                                    <Tag color="#905b3969" style={{ color: 'black', marginBottom: '8px' }}>Awaiting
                                        review</Tag>
                                    <Tag color="#cbc8a169" style={{ color: 'black', marginBottom: '8px' }}>Fixed</Tag>
                                    <Tag color="#aacb7869"
                                         style={{ color: 'black', marginBottom: '8px' }}>Duplicate</Tag>
                                    <Tag color="#ee87c569"
                                         style={{ color: 'black', marginBottom: '8px' }}>Documentation</Tag>
